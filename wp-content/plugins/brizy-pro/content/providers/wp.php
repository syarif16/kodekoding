	...
	private function getTextPlaceholders() {
		...
		$holders = array_merge(
			array(
				...
				new BrizyPro_Content_Placeholders_SimplePostAware( 'Post Excerpt', 'brizy_dc_post_excerpt', function ( $context ) {
					return $context->getWpPost()->post_excerpt; //apply_filters( 'get_the_excerpt', $context->getWpPost()->post_excerpt );
				} ),
			...
			array(
				...
				/*new Brizy_Content_Placeholders_Simple( 'Current date time', 'brizy_dc_current_date_time', function () {
				...
				// TODO - Archive meta must be a dynamic key.
				/*new Brizy_Content_Placeholders_Simple( 'Archive Meta', 'brizy_dc_{$key}_archive_meta', wp_kses_post( '' ) ),*/
			)
		);
