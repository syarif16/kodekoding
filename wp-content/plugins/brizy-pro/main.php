...
//		}
	...
	public function inactivePlugin() {
        ...
        <div class="notice notice-error is-dismissible">
            <p><?php _e( 'Brizy Pro is inactive. Please install and activate Brizy first.!' ); ?></p>
        </div>
		<?php
	}
	...
	public function updateNeeded() {
		?>
        <div class="notice notice-error is-dismissible">
            <p><?php echo sprintf( __( 'Brizy Pro %s requires Brizy to be %s or newer', 'brizy' ), BRIZY_PRO_VERSION, BRIZY_REQUIRED_VERSION ); ?></p>
        </div>
		<?php
	}
	...
	public function filterBrizyEditorConfig( $config ) {
		...
		$config['user'] = array( 'role' => $accessType );
